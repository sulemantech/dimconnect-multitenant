        ...
        return (
            <HoverCard position="right-start">
                <HoverCard.Target>
                    ...
                    <div className={`flex items-center py-[30px] px-6 h-14 my-2 text-white font-light border-sky-600 transition-all border-b-[2px] hover:border-sky-600 hover:bg-[#0E76BB]`}>
                ...
                <HoverCard.Dropdown className="rounded-r-xl -ml-2 -mt-2 p-0 bg-white  ">
                    <div>
                        ...
                        <div className={`flex  items-center justify-center py-[25px] ${collapsed.value ? 'px-6' : 'px-4'}  text-[#0E76BB]  font-light border-neutral-200 transition-all border-b-[1px]   `}>
