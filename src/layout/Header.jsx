...
export default () => {
  ...
  useShallowEffect(() => {
    ...
    return (
      <div className="absolute shadow-lg border-white border-solid border-2 items-center right-0 left-0 m-2 rounded-2xl top-0 z-10 h-20 bg-opacity-80 flex px-4 bg-[#0071b9] backdrop-blur-2xl">
        <Burger
          onClick={() => {
