...
import api, { LoginChatServer, postAuth } from "../../api";
...
export default () => {
  ...
  return (
    <PublicWrapper>
      <div
        id="scale-down"
       style={{backgroundColor: tenantConfig.login.formbg}}
        className={`relative min-w-[350px] rounded-lg shadow-2xl pb-14 max-h-[80vh] max-laptop:max-h-[82vh] backdrop-blur-md max-laptop:min-w-[300px] max-[850px]:w-[200px]`}
      >
