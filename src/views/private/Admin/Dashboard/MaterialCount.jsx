        ...
        <CountCard
          ...
          count={
            loading ? (
              ...
              MaterialCount?.data?.demand_points || (
        ...
        <CountCard
          ...
          count={
            loading ? (
              ...
              Math.round(MaterialCount?.data?.feeder_cables) || (
                <span className="text-red-500 text-sm">No Data</span>
              )
            )
          }
        ...
        <CountCard
          ...
          count={
            loading ? (
              ...
              Math.round(MaterialCount?.data?.out_distributioncables) || (
                <span className="text-red-500 text-sm">No Data</span>
              )
            )
          }
        ...
        <CountCard
          ...
          count={
            loading ? (
              ...
              Math.round(MaterialCount?.data?.primary_distribution_cables) || (
                <span className="text-red-500 text-sm">No Data</span>
              )
            )
          }
        ...
        <CountCard
          ...
          count={
            loading ? (
              ...
              Math.round(MaterialCount?.data?.distribution_ducts) || (
                <span className="text-red-500 text-sm">No Data</span>
              )
            )
          }
        ...
        <CountCard
          ...
          count={
            loading ? (
              ...
              Math.round(MaterialCount?.data?.primary_distribution_ducts) || (
                <span className="text-red-500 text-sm">No Data</span>
              )
            )
          }
        ...
        <CountCard
          ...
          count={
            loading ? (
              ...
              Math.round(MaterialCount?.data?.feeder_ducts) || (
                <span className="text-red-500 text-sm">No Data</span>
              )
            )
          }
        ...
        <CountCard
          ...
          count={
            loading ? (
              ...
              Math.round(MaterialCount?.data?.drop_ducts) || (
                <span className="text-red-500 text-sm">No Data</span>
              )
            )
          }
...
const CountCard = ({ title, count }) => (
  <Paper
    withBorder
    className="flex-[1] flex flex-grow items-center px-4 min-h-[40px] md:min-h-[50px] m-1 bg-white shadow-lg rounded-xl"
  >
