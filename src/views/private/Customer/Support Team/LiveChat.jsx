  ...
  return (
    <div className="min-h-screen  bg-white">
      ...
      <div className=" h-auto bg-[#F5F7F942] text-[#3E3F3F] rounded-md border-[2px] mt-4 border-[#DDE7F0] w-[50%] font-[Roboto] ml-24 shadow-lg   ">
        ...
        <div className="h-50px overflow-y-auto max-laptop:h-[230px]">
            ...
            <div className="flex flex-1 space-x-4">
              ...
              <div>
                ...
                <p className="text-[12px]">
                  ...
                  played a major role in the company's strategy from the
                  earliest days: in fact, many Ferraris have made the
                  combination of absolute performance and first-class comfort
                  one of their pillars. Today, the result of this
                </p>
              </div>
            </div>
          </div>
