...
export default ({
  ...
  return (
    <div className="flex flex-col rounded-md  mb-10 ">
      <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
            <div className="flex justify-center bg-transparent p-2 text-neutral-700 text-xs items-center">
              <div className=" mr-[10px] p-1 border-[2px] border-solid border-[#0E76BB] rounded-lg">
                {" "}
              ...
              <Paper withBorder className="flex items-center  mr-2">
              ...
              <div className="flex items-center">
                <p className=" bg-white h-12 w-[100px] font-semibold text-brand flex items-center justify-center rounded-l-md ">Search</p>
                <Input
                  type="text"
                  variant="filled"
                  size="lg"
